...
var For2023Feb03 = time.Date(2023, time.February, 3, 0, 0, 0, 0, time.UTC)
...
func TestExtractDatetimesRanges(t *testing.T) {
	...
	tests := []test{
		{mode: "", input: "Feb 3 2023", want: &DateTimeTZRanges{Items: []*DateTimeTZRange{nil}}}, // NewDateTimeTZRange(For2023Feb03)
